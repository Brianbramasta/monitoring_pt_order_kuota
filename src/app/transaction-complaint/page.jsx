...
const cards = [
  {
    ...
    value: <span className="   font-bold">{recap.total_complaint_transactions || 0}</span>,
  },
  {
    ...
    value: <span className="   font-bold">Rp {recap.total_complaint_nominal?.toLocaleString('id-ID') || 0}</span>,
  },
  {
    ...
    value: <span className="   font-bold">{recap.total_unread_cs_messages || 0} pesan.</span>,
  }
];
